...
module.exports = {
    ...
    options: [{
        name: "server",
        description: "El servidor por el cual quieres recibir información.",
        type: 3,
        required: false
    }],
    ...
    run: async (client, interaction) => {
        ...
        if(!client.config.ownerID.includes(interaction?.user?.id)) return interaction.reply({ content: "No puedes usar este comando.", ephemeral: true }).catch(e => { });
